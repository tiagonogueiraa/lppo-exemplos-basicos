 ...
 * @author aluno
 */
public class CriaTabelaContato {
               ...
               public static void main(String[] args) {
                   try {
                       ...
                       System.out.println("Conexao aberta com sucesso!");
                            ...
                            String sql = "CREATE TABLE contato (nome VARCHAR(50), sobrenome VARCHAR(50)"
                                    + "TELEFONE INTEGER" + " email (VARCHAR(50) , atualizado TIMESTAMP)";
                       ...
                       Logger.getLogger(CriaTabelaContato.class.getName()).log(Level.SEVERE, null, ex);
